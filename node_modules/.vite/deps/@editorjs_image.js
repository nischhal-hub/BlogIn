...
var j = class _j {
   ...
   */
  render(a) {
    return !a.file || Object.keys(a.file).length === 0 ? this.toggleStatus(_j.status.EMPTY) : this.toggleStatus(_j.status.UPLOADING), this.nodes.wrapper;
  }
  /**
   ...
   */
  showPreloader(a) {
    this.nodes.imagePreloader.style.backgroundImage = `url(${a})`, this.toggleStatus(_j.status.UPLOADING);
  }
  /**
   ...
   */
  hidePreloader() {
    this.nodes.imagePreloader.style.backgroundImage = "", this.toggleStatus(_j.status.EMPTY);
  }
  /**
   * Shows an image
   *
  ...
  fillImage(a) {
    ...
    let r = "load";
    i === "VIDEO" && (c.autoplay = true, c.loop = true, c.muted = true, c.playsinline = true, r = "loadeddata"), this.nodes.imageEl = M(i, this.CSS.imageEl, c), this.nodes.imageEl.addEventListener(r, () => {
      this.toggleStatus(_j.status.FILLED), this.nodes.imagePreloader && (this.nodes.imagePreloader.style.backgroundImage = "");
   ...
   */
  toggleStatus(a) {
    for (const i in _j.status)
      Object.prototype.hasOwnProperty.call(_j.status, i) && this.nodes.wrapper.classList.toggle(`${this.CSS.wrapper}--${_j.status[i]}`, a === _j.status[i]);
  }
  /**
  ...
  (function(i, c) {
    ...
    return function(i) {
      ...
      function r(n) {
        if (c[n])
          return c[n].exports;
        var o = c[n] = { i: n, l: false, exports: {} };
        return i[n].call(o.exports, o, o.exports, r), o.l = true, o.exports;
      }
      return r.m = i, r.c = c, r.d = function(n, o, d) {
        r.o(n, o) || Object.defineProperty(n, o, { enumerable: true, get: d });
      }, r.r = function(n) {
        ...
        if (r.r(d), Object.defineProperty(d, "default", { enumerable: true, value: n }), 2 & o && typeof n != "string")
          for (var b in n)
            r.d(d, b, (function(u) {
              return n[u];
            }).bind(null, b));
      ...
      }, o.title = "browser", o.browser = true, o.env = {}, o.argv = [], o.version = "", o.versions = {}, o.on = l, o.addListener = l, o.once = l, o.off = l, o.removeListener = l, o.removeAllListeners = l, o.emit = l, o.prependListener = l, o.prependOnceListener = l, o.listeners = function(s) {
        return [];
      ...
      var r = function(o) {
        ...
        return d = d || null, b = b || "&", u = u || null, o ? function(f) {
          ...
          if (u && (w = u + "[" + w + "]"), typeof o[f] == "object" && o[f] !== null)
            ...
            var v = o[f];
            v = (v = (v = (v = v === true ? "1" : v) === false ? "0" : v) === 0 ? "0" : v) || "", p = r(w) + "=" + r(v);
          }
          return p;
        })).join(b).replace(/[!'()*]/g, "") : "";
      };
...
var P = class _P {
   ...
   */
  renderSettings() {
    return _P.tunes.concat(this.config.actions).map((i) => ({
      icon: i.icon,
   ...
   */
  set data(a) {
    this.image = a.file, this._data.caption = a.caption || "", this.ui.fillCaption(this._data.caption), _P.tunes.forEach(({ name: i }) => {
      const c = typeof a[i] < "u" ? a[i] === true || a[i] === "true" : false;
      this.setTune(i, c);
    });
  }
  /**
